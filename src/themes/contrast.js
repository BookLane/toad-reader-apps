...
const theme = {
  ...
  // Light theme defaults below.
  // Check here for updates: https://github.com/eva-design/eva/blob/master/packages/eva/themes/light.json
